...
import 'package:modyfikacja_aplikacja/app/features/home/pages/check/pages/category_pages/entertainment_page/cubit/entertainment_cubit.dart';
...
class FunPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => EntertainmentCubit()..start(),
...
class EntertainmentTasks extends StatelessWidget {
