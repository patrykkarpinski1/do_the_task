...
import 'package:modyfikacja_aplikacja/app/features/home/pages/tasks/pages/category_pages/family_page/cubit/family_cubit.dart';
...
class FamilyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => FamilyCubit()..start(),
