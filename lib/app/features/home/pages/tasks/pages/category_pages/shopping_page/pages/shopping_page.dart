...
import 'package:modyfikacja_aplikacja/app/features/home/pages/tasks/pages/category_pages/shopping_page/cubit/shopping_cubit.dart';
...
class ShoppingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => ShoppingCubit()..start(),
