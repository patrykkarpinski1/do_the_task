...
import 'package:modyfikacja_aplikacja/app/features/home/pages/tasks/pages/category_pages/fees_page/cubit/fees_cubit.dart';
...
class BillsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => FeesCubit()..start(),
...
class FeesTasks extends StatelessWidget {
  const FeesTasks({
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () {
                      context.read<FeesCubit>().remove(documentID: document.id);
                    },
