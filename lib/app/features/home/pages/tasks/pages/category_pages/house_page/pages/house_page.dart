...
import 'package:modyfikacja_aplikacja/app/features/home/pages/tasks/pages/category_pages/house_page/cubit/house_cubit.dart';
...
class HousePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => HouseCubit()..start(),
...
class HouseTasks extends StatelessWidget {
  const HouseTasks({
